      ...
      options: {
        ...
        plugins: {
          ...
          tooltip: {
            ...
            borderWidth: 1,
            callbacks: { label: (ctx) => ' Rs. ' + Number(ctx.raw).toFixed(2) },
          },
        },
      },
    });
    ...
    this.bar = new Chart(this.barRef.nativeElement, {
      ...
      options: {
        ...
        scales: {
          ...
          y: {
            grid: { color: 'rgba(255,255,255,0.04)' },
            ticks: { color: '#7a84a0', callback: (v) => 'Rs. ' + v },
            border: { color: 'rgba(255,255,255,0.07)' },
          },
        },
        plugins: {
          ...
          tooltip: {
            ...
            callbacks: {
              label: (ctx) =>
                ' ' + ctx.dataset.label + ': Rs. ' + Number(ctx.raw).toFixed(2),
            },
          },
        },
      },
